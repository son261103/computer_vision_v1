...
class VideoThread(QThread):
    ...
    def __init__(self, detector, video_path, parent=None):
        ...
        self.skip_frames = 1  # For speed control
    ...
    def run(self):
        try:
            ...
            while self.running and cap.isOpened():
                if not self.paused:
                    ...
                    stats = {
                        ...
                        'estimated_time': self.calculate_estimated_time(
                            frame_count, total_frames, current_fps)
                    }
                ...
                self.msleep(max(1, int(1000 / (fps * 2))))
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Add new attributes for enhanced features
